# Web app v2.8 — Fullscreen toolbar fix
...
### v2.8 Play navigation fix
Play-mode Fit, 1:1, zoom in, and zoom out are now explicitly wired to the runtime canvas. Fit uses the logical runtime canvas dimensions and does not change widget geometry.
